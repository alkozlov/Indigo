    ...
    public partial class InventoryManagementForm : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!this.DesignMode)
            {
                ...
                this.chartHome.DataSource = chartData;
                this.chartReportsStock.DataSource = chartData;

                this.chartReportsSales.DataSource = InventoryDataSource.GetTable(Table.ChartData2);
            }
        }
        ...
        {
            ResourceManager rm = InventoryManagement1.Properties.Resources.ResourceManager;
